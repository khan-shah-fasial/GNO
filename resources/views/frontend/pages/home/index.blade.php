...
<!-----===== home content start============---->
 ...
 <section class="hero">
    ...
    <section class="course">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2
              class="heading text-center arsenica_fonts"
              data-aos-once="true"
              data-aos="fade-up"
            >
              Courses you learn
              ...
              <div class="owl-carousel owl-theme" id="course">
                <div class="item" data-aos-once="true" data-aos="fade-up">
                  <div class="card_course">
                     <div class="overlay" >
                     <img
                      src="assets/frontend/images/quran.png"
                      alt=""
                      data-aos-once="true"
                      data-aos="fade-up"
                    />
                    ...
                    <div class="card_content">
                      ...
                      <p class="desc" data-aos-once="true" data-aos="fade-up">
                        No doubt the knowledge of Quran is the best of all knowledge and it is necessary for Muslims to not only learn the recitation of Holy Quran but also get to know the commandments and rulings of Sharia mentioned in it. Dawat-e-Islami has introduced a very beautiful Faizan-e-Tafseer 
                      </p>
                ...
                <div class="item" data-aos-once="true" data-aos="fade-up">
                  <div class="card_course">
                        <div class="overlay" >
                         <img
                      src="assets/frontend/images/madni.png"
                      alt=""
                      data-aos-once="true"
                      data-aos="fade-up"
                    />
                    ...
                    <div class="card_content">
                      <h3
                        ...
                        data-aos="fade-up"
                      >
                       Roze ke ahkam Course
                      </h3>
                      <p class="desc" data-aos-once="true" data-aos="fade-up">
                        Fasting is one of the sacred pillars of Islam and observed in the month of Ramadan every lunar year by every sane male and female Muslim. Ahkam e Roza Course will acknowledge you the importance of Ramzan and its fasts, conditions in which a fast will not be broken, who can give Kaffara in place of fast, Sunnah of Eid Salah, Sharia rulings regarding Fitrana and much other Islamic guidance related new matters to fasting like injection or drip.
                      </p>
                       <div class="row">
                          <div class="col-md-6">
                              <div class="social_icons">
                ...
                <div class="item" data-aos-once="true" data-aos="fade-up">
                  <div class="card_course">
                        <div class="overlay" >
                          <img
                      src="assets/frontend/images/imam.png"
                      alt=""
                      data-aos-once="true"
                      data-aos="fade-up"
                    />
                    ...
                    <div class="card_content">
                      ...
                      <p class="desc" data-aos-once="true" data-aos="fade-up">
                        In Islam the most supreme act of worship is Namaz and it is obligatory upon every Muslim to perform it in a prescribed manner. In this course, you will not only learn the method of five obligatory prayers with them you will also learn Funeral Namaz, Eid Namaz, Nawafil, relaxation in Namaz for a traveler and much more.
                      </p>
                       <div class="row">
                          <div class="col-md-6">
                              <div class="social_icons">
                ...
                <div class="item" data-aos-once="true" data-aos="fade-up">
                  <div class="card_course">
                        <div class="overlay" >
                          <img
                      src="assets/frontend/images/darse.png"
                      alt=""
                      data-aos-once="true"
                      data-aos="fade-up"
                    />
                    ...
                    <div class="card_content">
                      ...
                      <p class="desc" data-aos-once="true" data-aos="fade-up">
                        Imamat course will rectify the mistakes you make in your Salah so that you not only rectify yours but others Salah as well. Moreover, you will learn that what Islamic qualification is required to lead Salah as an Imam, conditions for Imam, types of Imamat and by doing Imamat how can you increase the Madni work of Dawat-e-Islami.
                      </p>
                        <div class="row">
                          <div class="col-md-6">
                        <div class="social_icons">
            ...
            <div class="col-md-12">
              <div class="text-center mt-2">
                <a href="courses.php" class="view_all_btn">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left_wrapper">
              <h2
                class="heading mb-4 arsenica_fonts"
                data-aos-once="true"
                data-aos="fade-up"
              >
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="wrapper">
              ...
              <a target="_blank" href="https://online.gnoa.in/apex/f?p=104:11::::::" class="common_btn mt-5">Register Now</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="wrapper">
              <div class="img">
                <img
                  src="assets/frontend/images/why_1.png"
                  alt=""
                  data-aos-once="true"
                  data-aos="fade-up"
                />
          ...
          <div class="col-md-4">
            <div class="wrapper">
              <div class="img">
                <img
                  src="assets/frontend/images/why_2.png"
                  alt=""
                  data-aos-once="true"
                  data-aos="fade-up"
                />
          ...
          <div class="col-md-4">
            <div class="wrapper">
              <div class="img">
                <img
                  src="assets/frontend/images/why_3.png"
                  alt=""
                  data-aos-once="true"
                  data-aos="fade-up"
                />
          ...
          <div class="col-md-4">
            <div class="wrapper">
              <div class="img">
                <img
                  src="assets/frontend/images/why_4.png"
                  alt=""
                  data-aos-once="true"
                  data-aos="fade-up"
                />
          ...
          <div class="col-md-4">
            <div class="wrapper">
              <div class="img">
                <img
                  src="assets/frontend/images/why_5.png"
                  alt=""
                  data-aos-once="true"
                  data-aos="fade-up"
                />
          ...
          <div class="col-md-4">
            <div class="wrapper">
              <div class="img">
                <img
                  src="assets/frontend/images/why_6.png"
                  alt=""
                  data-aos-once="true"
                  data-aos="fade-up"
                />
    ...
    <img
      src="assets/frontend/images/patti.png"
      alt=""
      class="patti"
      data-aos-once="true"
      data-aos="fade-up"
