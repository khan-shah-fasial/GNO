             ...
             <div class="col-md-4">
              <div class="contact_boxex" data-aos-once="true" data-aos="fade-up">
                  <div class="contacticnbx">
                   ...
                   <h4>Address</h4>
                   <p>Faizane Madina Dawateislami India 50,Tantanpura Street Khadak Police Chowki Mumbai 400009 Maharshtra</p>
              </div>
            </div>
        ...
        <div class="row pt-4">
            <div class="col-md-4">
                <div class="question_sec" data-aos-once="true" data-aos="fade-up">
                     ...
                     <h3 class="arsenica_fonts">Dont be a stranger<br>just say hello.</h3>
                     <p>We will connect back to you in next few<br>moments. Our team of professional<br>alims and scholars are always there to<br>help and guide you.</p>
                </div>
